...
{#if !currentHub.plugins.broadcasts && !currentHub.plugins.events && !currentHub.plugins.resources}
...
{:else}
	<div class="space-y-6">
		{#if currentHub.plugins.broadcasts || currentHub.plugins.events}
		...
		<div class="card-grid">
			...
			{#if currentHub.plugins.resources}
